...
var me = {
    ...
    homeTown: 'Colts Neck',
    superPowers: [
        "Putting off getting gas until its almost too late, but never actually running out",
...
function setColor(arr) { 
    ...
    arr.length > 3 ? arr.splice(0, 3) : null

    for (let color of arr) { 
        color == 'blue' ? color = '#4D4DFF' : null
    }
