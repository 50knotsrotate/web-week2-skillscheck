...
function checkGroceryCount() { 
    var length = groceries.length //just so I dont have to calculate groceries.length OVA AND OVA AAGGAAYYNNNNNNN

   return length >= 5 ? 'That looks like a big trip' : length ==1 ? "1 item" : `${length} items` //Okay, I know, I know, nested terneries are evil...But.. hear me out... I do what I want. 
}
